            ...
            <div className="flex flex-wrap gap-3">
                {colors.map(color => (
                    <button
                        ...
                        className={`w-8 h-8 rounded-full transition-transform transform hover:scale-110 ${resume.accentColor === color.value ? 'ring-2 ring-offset-2 ring-offset-primary ring-text-light' : ''}`}
